...
process generate_run_summary_sc {
    ...
    echo "- Unique GBC in bulk reference:         \$(cat ${params.bulk_outdir}/${sample_name}/read_count_by_GBC_corrected.tsv | wc -l | LC_ALL=en_US.UTF-8 awk '{ printf("%'"'"'d", \$0) }')" >> run_summary.txt
